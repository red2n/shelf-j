...
import 'package:shelf_app/features/admin/staff_screen.dart';
...
class _Server implements HttpClientAdapter {
  ...
  Future<ResponseBody> fetch(
    ...
    if (o.path.endsWith('/admin/roles/permissions')) {
      ...
      body = '{"data":[{"id":"a1","userId":"01a0-user","storeId":"01a0-store","role":"SHIFT_LEAD","baseTier":"MANAGER","assignedAt":"2026-09-13T00:00:00Z"}],"meta":{}}';
...
void main() {
  ...
  group('the people tab', () {
    testWidgets('an assignment through a custom role says which tier it stands on', (tester) async {
      await _pump(tester);
      expect(find.text('SHIFT_LEAD'), findsOneWidget);
    ...
    testWidgets('the assign dialog offers the tenant\'s own roles beside the tiers', (tester) async {
      ...
      await tester.pumpAndSettle();
      expect(find.text('Shift lead (SHIFT_LEAD, on MANAGER)'), findsWidgets);
