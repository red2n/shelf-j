...
import 'package:shelf_app/features/admin/settlements_screen.dart';
...
void main() {
  ...
  testWidgets('an import is not sent until it says who paid and has a file, and then carries both', (tester) async {
    ...
    expect(sent.data, {'provider': 'Worldpay', 'format': 'SHELFJ', 'reference': 'WP-9', 'declaredNet': 10.0, 'content': 'type,reference,gross\nSALE,A1,10.00\n'});
