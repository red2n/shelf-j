...
import 'package:shelf_app/features/admin/tenant_data_providers.dart';
import 'package:shelf_app/features/admin/tenant_data_screen.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      await refuses('', 'empty');
      await refuses('{"format":"something-else"}', 'Not a Shelf-J data bundle');
      await refuses('not json at all', 'Not a Shelf-J data bundle');
      await refuses(
        _bundle([
          {
            'service': 'product-svc',
