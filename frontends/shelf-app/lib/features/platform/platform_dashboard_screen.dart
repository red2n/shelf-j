            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _Step(n: 1, text: 'A business owner goes to the app and clicks "New here? Create an account."'),
                  _Step(n: 2, text: 'They register with their email and password — they get a CUSTOMER role initially.'),
                  _Step(n: 3, text: 'The onboarding wizard immediately appears: they enter their business name, country, and currency.'),
                  _Step(n: 4, text: 'Next they add their first store (name, address, timezone). The OWNER role is automatically granted.'),
                  _Step(n: 5, text: 'They land on the Admin Dashboard and can manage inventory, orders, and staff from there.'),
                ],
              ),
            ),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _ApiRow(method: 'POST', path: '/api/iam-svc/auth/register', desc: 'Tenant owner self-registers'),
                  _ApiRow(method: 'POST', path: '/api/tenant-svc/onboarding/tenants', desc: 'Create tenant (step 1)'),
                  _ApiRow(method: 'POST', path: '/api/tenant-svc/onboarding/stores', desc: 'Create first store (step 2)'),
                  _ApiRow(method: 'GET', path: '/api/tenant-svc/admin/stores', desc: 'List tenant\'s stores'),
                  _ApiRow(method: 'GET', path: '/api/order-svc/orders', desc: 'List tenant orders'),
                  _ApiRow(method: 'GET', path: '/api/inventory-svc/admin/inventory/levels', desc: 'Stock levels'),
                ],
              ),
            ),
          ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: isGet ? Colors.green.withOpacity(0.15) : Colors.blue.withOpacity(0.15),
