...
const tenantBundleFormat = 'storeql-tenant-bundle/1';
...
Future<TenantDataImport> importTenantDataBundle(
  ...
  final header = _decode(lines.first, 'Not a StoreQL data bundle.');
  if (header is! Map || header['format'] != tenantBundleFormat) {
    throw const FormatException('Not a StoreQL data bundle.');
  }
