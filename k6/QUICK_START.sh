...
echo "   2. Read detailed guide: cat k6/FLOW_GUARD_TEST_GUIDE.md"
echo "   3. Check coverage audit: cat k6/ENDPOINT_COVERAGE_AUDIT.md"
echo "   4. Run full-stack test: k6 run k6/full-stack-simulation.js"
echo ""
...
echo "   • For help: See k6/FLOW_GUARD_TEST_GUIDE.md#troubleshooting"
echo ""
