...
FUNCTIONAL=(
  ...
  iam-crud tenant-crud product-crud inventory-crud pricing-crud order-crud notification-crud reporting-crud demand-forecast-flow order-proposal-flow loyalty-flow
