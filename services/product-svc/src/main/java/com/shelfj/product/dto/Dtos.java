...
public final class Dtos {
    ...
    public record CreateProductRequest(
            @NotBlank String name, String description, String brandId, String categoryId,
            Boolean sellableOnline, Boolean sellablePos) {}

    public record UpdateProductRequest(
            @NotBlank String name, String description, String brandId, String categoryId,
            @NotNull Boolean sellableOnline, @NotNull Boolean sellablePos) {}
    ...
    public record ProductResponse(
            String id, String name, String description, String brandId, String categoryId,
            String status, boolean sellableOnline, boolean sellablePos) {}

    public record VariantResponse(String id, String productId, String sku, String barcode, String attributes, String unit) {}
}
