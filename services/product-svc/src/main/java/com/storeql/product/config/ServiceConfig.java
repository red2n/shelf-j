package com.storeql.product.config;
...
public class ServiceConfig extends BaseServiceConfig {
  ...
  @Inject
  @ConfigProperty(name = "storeql.service.name", defaultValue = "product-svc")
  String serviceName;
  ...
  @Inject
  @ConfigProperty(name = "storeql.db.schema", defaultValue = "product")
  String dbSchema;
