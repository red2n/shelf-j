...
/**
 * Business logic for widgets. The "brain" — all rules live here, not in the resource (golden rule #9).
 * Every method takes the tenantId (sourced from context by the resource) and never trusts caller-supplied tenant.
 */
@ApplicationScoped
