...
import com.shelfj.iam.mfa.MfaTestAuthenticator;
...
class MfaIT {
  ...
  void anAuthenticatorApp() {
    ...
    assertThat(begun.data().getString("otpauthUri"), containsString("issuer=Shelf-J"));
    assertThat(
  ...
  void aPasskey() {
    ...
    assertThat(
        ...
        call(
                ...
                "/auth/mfa/login",
                Caller.NOBODY,
                key.assertionJson(waiting, toSign, "https://shelf-j.evil.test"))
            .code(),
        is("MFA_CODE_INVALID"));
