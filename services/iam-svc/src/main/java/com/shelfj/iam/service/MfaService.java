...
import com.shelfj.iam.auth.KeySealer;
...
import com.shelfj.iam.dto.MfaDtos;
import com.shelfj.iam.mfa.RecoveryCodes;
import com.shelfj.iam.mfa.Totp;
import com.shelfj.iam.mfa.WebAuthn;
import com.shelfj.iam.repo.MfaRepository;
...
public class MfaService {
  ...
  @PostConstruct
  void init() {
    sealer = new KeySealer(config.jwtSecret(), "shelfj-mfa-secret-seal:");
  }
