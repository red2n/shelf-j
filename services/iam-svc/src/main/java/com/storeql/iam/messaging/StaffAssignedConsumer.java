...
/**
 * Kafka infrastructure for {@code storeql.tenant.staff-assigned}. Polls the topic and dispatches
...
class StaffAssignedConsumer extends BaseKafkaConsumer {
  ...
  @Inject
  @ConfigProperty(
      name = "storeql.kafka.topics.staff-assigned",
      defaultValue = "storeql.tenant.staff-assigned")
  String topicCfg;
