...
/**
 * Business handler for {@code storeql.tenant.tenant-status-changed}: ends every active POS session
 ...
 *
 * <p>Login/refresh are already blocked by {@link com.storeql.iam.service.AuthService} once
