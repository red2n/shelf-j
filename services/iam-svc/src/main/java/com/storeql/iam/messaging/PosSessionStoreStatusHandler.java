...
/**
 * Business handler for {@code storeql.tenant.store-status-changed}: ends every active POS session
 * at a store that just went non-ACTIVE and revokes the affected cashiers' refresh tokens. Separated
