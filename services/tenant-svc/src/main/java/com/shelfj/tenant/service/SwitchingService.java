...
public class SwitchingService {
  ...
  static final String ERASURE_TOPIC = "shelfj.tenant.tenant-data-erasure-due";
  ...
  @Inject
  @ConfigProperty(
      name = "shelfj.switching.services",
      defaultValue =
