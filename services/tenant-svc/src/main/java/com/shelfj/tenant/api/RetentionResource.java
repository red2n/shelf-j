...
import com.shelfj.tenant.dto.RetentionDtos.PlaceHoldRequest;
import com.shelfj.tenant.dto.RetentionDtos.ReleaseHoldRequest;
import com.shelfj.tenant.dto.RetentionDtos.RunResponse;
import com.shelfj.tenant.dto.RetentionDtos.SetPeriodRequest;
import com.shelfj.tenant.dto.RetentionDtos.SheetResponse;
import com.shelfj.tenant.mapper.RetentionMappers;
...
public class RetentionResource {
   ...
   *
   * @throws com.shelfj.web.ApiException {@code 400} unknown class, a period outside 0..36500, or
   ...
   * @throws com.shelfj.web.ApiException {@code 400} unknown class, or a subject that does not match
   *     the kind
   */
  @Operation(
   ...
   * Releases a hold.
   *
   * @throws com.shelfj.web.ApiException {@code 404} no such hold; {@code 409} already released
   */
