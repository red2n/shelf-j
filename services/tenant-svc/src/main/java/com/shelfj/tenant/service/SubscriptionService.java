...
public class SubscriptionService {
  ...
  public SubscriptionFile setDetails(
      UUID tenantId, com.shelfj.tenant.dto.BillingDtos.BuyerRequest req, UUID actorId) {
    Subscription s = require(tenantId);
    Buyer before = s.buyer();
    Buyer after = com.shelfj.tenant.mapper.BillingMappers.merge(before, req);
  ...
  public SubscriptionFile changePlan(
      UUID tenantId, com.shelfj.tenant.dto.BillingDtos.PlanChangeRequest req, UUID actorId) {
    billable(tenantId);
