...
public final class Domain {
    ...
    public record Tenant(
            UUID id, String name, String legalName, String status, UUID planId,
            UUID ownerUserId, String country, String currency, Instant createdAt) {
        public static final String STATUS_PENDING = "PENDING";
        public static final String STATUS_ACTIVE = "ACTIVE";
    }

    public record Store(
            UUID id, UUID tenantId, String name, String code, String type,
            ...
            String timezone, String businessHours, String status, boolean isDefault, Instant createdAt) {
        public static final String TYPE_STORE = "STORE";
    }

    public record Zone(
            UUID id, UUID tenantId, UUID storeId, String name, String code,
