...
public class PtSigningKey {
  ...
  @Inject
  @ConfigProperty(name = "storeql.fiscal.pt.private-key")
  Optional<String> privateKeyConfig;

  /** The key version the AT knows this key as: SAF-T's HashControl. */
  @Inject
  @ConfigProperty(name = "storeql.fiscal.pt.key-version", defaultValue = "1")
  String keyVersion;
  ...
  public PrivateKey privateKey() {
    if (privateKey == null) {
      throw new IllegalStateException("storeql.fiscal.pt.private-key is not configured");
    }
    return privateKey;
  }
