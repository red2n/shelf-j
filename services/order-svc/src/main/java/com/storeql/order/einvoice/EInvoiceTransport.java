...
public interface EInvoiceTransport {
  ...
  record Outcome(String state, String detail, String response, String reference) {
    ...
    public static Outcome accepted(String detail, String response) {
      return new Outcome(
          com.storeql.order.domain.EInvoiceTransports.STATUS_ACCEPTED, detail, response, null);
    }

    public static Outcome rejected(String detail, String response) {
      return new Outcome(
          com.storeql.order.domain.EInvoiceTransports.STATUS_REJECTED, detail, response, null);
    }

    public static Outcome pending(String detail, String response) {
      return new Outcome(
          com.storeql.order.domain.EInvoiceTransports.STATUS_PENDING, detail, response, null);
    }
  }
