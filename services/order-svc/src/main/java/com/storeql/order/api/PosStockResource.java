...
import com.storeql.order.domain.Domain.PosStockPosition;
import com.storeql.order.dto.Dtos.PosStockPositionResponse;
 ...
 * com.storeql.order.messaging.InventoryEventConsumer}). It is eventually consistent — not a
