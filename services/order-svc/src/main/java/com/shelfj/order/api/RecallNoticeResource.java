...
import com.shelfj.order.dto.RecallNoticeDtos.NoticeResponse;
import com.shelfj.order.dto.RecallNoticeDtos.ProgressResponse;
import com.shelfj.order.dto.RecallNoticeDtos.RemedyRequest;
import com.shelfj.order.dto.RecallNoticeDtos.ResolveRequest;
import com.shelfj.order.mapper.RecallNoticeMappers;
import com.shelfj.order.service.RecallNoticeService;
...
public class RecallNoticeResource {
   ...
   *
   * @throws com.shelfj.web.ApiException {@code NO_CUSTOMER} (401) when the token carries no login
   */
  @Operation(
   ...
   * @throws com.shelfj.web.ApiException {@code 404} no such notice, or not this shopper's; {@code
   ...
   * @throws com.shelfj.web.ApiException {@code 400} REFUNDED here; {@code 404} no such notice;
