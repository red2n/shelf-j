 ...
 *
 * <p>Fail-open: a missing row means ACTIVE, preserving back-compat for tenants created before the
 * projection existed and keeping orders flowing during brief event-delivery lag.
 */
@ApplicationScoped
