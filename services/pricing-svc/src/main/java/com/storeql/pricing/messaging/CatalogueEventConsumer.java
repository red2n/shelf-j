...
class CatalogueEventConsumer extends BaseKafkaConsumer {
  ...
  @Inject
  @ConfigProperty(
      name = "storeql.kafka.topics.product-categorised",
      defaultValue = "storeql.catalog.product-categorised")
  String categorised;

  @Inject
  @ConfigProperty(
      name = "storeql.kafka.topics.variant-created",
      defaultValue = "storeql.catalog.variant-created")
  String variantCreated;

  @Inject
  @ConfigProperty(
      name = "storeql.kafka.topics.variant-measured",
      defaultValue = "storeql.catalog.variant-measured")
