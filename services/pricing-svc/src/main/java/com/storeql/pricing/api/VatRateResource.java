...
public class VatRateResource {
   ...
   * @throws com.storeql.web.ApiException {@code 400} when the rate exceeds 1
   */
  @Operation(
   ...
   * @return the rate
   * @throws com.storeql.web.ApiException {@code 404} when the code is not configured
   */
   ...
   * @throws com.storeql.web.ApiException {@code 400} when the rate exceeds 1; {@code 404} when the
