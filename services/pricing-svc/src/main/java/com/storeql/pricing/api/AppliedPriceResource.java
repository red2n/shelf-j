...
import com.storeql.pricing.dto.Dtos.PriceHistoryResponse;
...
public class AppliedPriceResource {
  ...
  @Inject com.storeql.pricing.service.PricingService pricing;
  ...
  @GET
  @Path("/reductions")
  public ApiResponse<com.storeql.pricing.dto.Dtos.ReductionsResponse> reductions(
    ...
    return ApiResponse.ok(
        new com.storeql.pricing.dto.Dtos.ReductionsResponse(
            key,
            service.pending(tenantId),
