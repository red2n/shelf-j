 ...
 * from each line in the GRN payload, idempotently (dedupe on eventId). Separated from {@link
 * GoodsReceivedConsumer} so Kafka lifecycle and domain logic each have a single reason to change
 * (SRP).
 *
