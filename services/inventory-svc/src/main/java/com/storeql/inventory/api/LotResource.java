...
public class LotResource {
   ...
   *
   * @param req the request body
   * @throws com.storeql.web.ApiException {@code 404} source batch not found; {@code 422} split qty
   ...
   *
   * @param req the request body
   * @throws com.storeql.web.ApiException {@code 404} source or target batch not found; {@code 422}
   ...
   * @param req the request body
   * @throws com.storeql.web.ApiException {@code 400} grade must not be blank; {@code 404} no such
   *     batch
   */
