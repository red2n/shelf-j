...
import com.storeql.inventory.domain.FoodSafety.CheckType;
import com.storeql.inventory.domain.FoodSafety.CorrectiveAction;
import com.storeql.inventory.domain.FoodSafety.DiaryEntry;
import com.storeql.inventory.domain.FoodSafety.FoodDisposition;
import com.storeql.inventory.domain.FoodSafety.Kind;
import com.storeql.inventory.domain.FoodSafety.Limits;
import com.storeql.inventory.domain.FoodSafety.MonitoringPoint;
import com.storeql.inventory.domain.FoodSafety.OverduePoint;
import com.storeql.inventory.domain.FoodSafety.PointStatus;
import com.storeql.inventory.domain.FoodSafety.Result;
import com.storeql.inventory.domain.FoodSafety.Review;
import com.storeql.inventory.repo.FoodSafetyRepository;
...
public class FoodSafetyService {
  ...
  static final String TOPIC_CHECK_FAILED = "storeql.inventory.food-safety-check-failed";
  static final String TOPIC_CHECK_OVERDUE = "storeql.inventory.food-safety-check-overdue";
