...
import com.storeql.inventory.dto.FoodSafetyDtos.CheckRecordResponse;
import com.storeql.inventory.dto.FoodSafetyDtos.CheckTypeResponse;
import com.storeql.inventory.dto.FoodSafetyDtos.CorrectiveActionRequest;
import com.storeql.inventory.dto.FoodSafetyDtos.PointResponse;
import com.storeql.inventory.dto.FoodSafetyDtos.RecordCheckRequest;
import com.storeql.inventory.mapper.FoodSafetyMappers;
import com.storeql.inventory.service.FoodSafetyService;
import com.storeql.inventory.service.FoodSafetyService.RecordCheck;
...
public class FoodSafetyResource {
   ...
   * @throws com.storeql.web.ApiException {@code 403} caller is not assigned to the point's store;
   ...
   * @throws com.storeql.web.ApiException {@code 404} no such record
   */
   ...
   * @throws com.storeql.web.ApiException {@code 404} no such record; {@code 409} the check passed
   */
  @Operation(
