...
public class SerialResource {
   ...
   * @throws com.storeql.web.ApiException {@code 400} autoQty exceeds 200
   */
  @Operation(
   ...
   * @throws com.storeql.web.ApiException {@code 400} serial_no query param is required; {@code 404}
   ...
   * @throws com.storeql.web.ApiException {@code 404} no such serial number
   */
