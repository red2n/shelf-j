...
public class ServiceConfig extends BaseServiceConfig {
  ...
  @Inject
  @ConfigProperty(name = "storeql.service.name", defaultValue = "inventory-svc")
  String serviceName;
  ...
  @Inject
  @ConfigProperty(name = "storeql.db.schema", defaultValue = "inventory")
  String dbSchema;

  /** Default reservation lifetime if the caller doesn't specify one (abandoned-cart release). */
  @Inject
  @ConfigProperty(name = "storeql.inventory.reservation-ttl-seconds", defaultValue = "900")
