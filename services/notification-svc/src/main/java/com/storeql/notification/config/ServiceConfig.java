 ...
 * com.storeql.notification.channel.NotificationChannelProducer} instead.
 */
@ApplicationScoped
public class ServiceConfig extends BaseServiceConfig {

  @Inject
  @ConfigProperty(name = "storeql.service.name", defaultValue = "notification-svc")
  String serviceName;
  ...
  @Inject
  @ConfigProperty(name = "storeql.db.schema", defaultValue = "notification")
  String dbSchema;
