...
import com.storeql.notification.dto.Dtos.NotificationDto;
import com.storeql.notification.dto.Dtos.ShortageAlertDto;
...
public final class Mappers {
  ...
  public static com.storeql.notification.dto.Dtos.PushDeviceResponse toDto(
      com.storeql.notification.domain.Domain.PushDevice d) {
    String t = d.token();
    return new com.storeql.notification.dto.Dtos.PushDeviceResponse(
        d.id().toString(),
        d.platform(),
