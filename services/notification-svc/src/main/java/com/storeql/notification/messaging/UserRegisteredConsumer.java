...
/**
 * Polls {@code storeql.iam.user-registered} and dispatches to {@link UserRegisteredHandler}, which
...
class UserRegisteredConsumer extends BaseKafkaConsumer {
  ...
  @Inject
  @ConfigProperty(
      name = "storeql.kafka.topics.user-registered",
      defaultValue = "storeql.iam.user-registered")
  String topic;
