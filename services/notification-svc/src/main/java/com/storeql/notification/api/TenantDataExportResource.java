...
/**
 * {@code /admin/tenant-data}: what notification-svc holds for the owner's business, its rows page
 * by page, and their import into a fresh business (21.14, EU Data Act ch.VI). The owner alone.
 */
