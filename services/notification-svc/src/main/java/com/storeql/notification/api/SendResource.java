...
import com.storeql.notification.channel.PushChannel;
import com.storeql.notification.channel.SmsChannel;
import com.storeql.notification.domain.Domain.Channel;
import com.storeql.notification.dto.Dtos.SendNotificationRequest;
import com.storeql.notification.dto.Dtos.SendNotificationResponse;
 ...
 * com.storeql.web.AdminAuthorizationFilter} still requires any staff role on POST.
...
public class SendResource {
   ...
   * @throws com.storeql.web.ApiException {@code 403} when the caller holds no staff role
   */
  @Operation(
