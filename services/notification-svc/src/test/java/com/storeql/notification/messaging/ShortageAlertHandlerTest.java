 ...
 * {@code storeql.notification.channel=mqtt}. The two are independently idempotent: a redelivery
 * must still retry a push that previously failed, even though the alert row is already there from
