...
/**
 * Convenience immutable base carrying the common {@link DomainEvent} envelope fields.
 * Concrete events extend this and add their own payload fields.
 *
 * <p>Example:
 * <pre>{@code
...
public abstract class BaseEvent implements DomainEvent {
    ...
    protected BaseEvent(UUID eventId,
                        String eventType,
                        UUID tenantId,
                        UUID aggregateId,
                        Instant occurredAt) {
