 ...
 *
 * <p>Events are <strong>past-tense facts</strong> ({@code OrderPlaced}, {@code StockReceived}) published to Kafka
 * via the transactional outbox. Every event is tenant-scoped and idempotently consumable: consumers dedupe on
 * {@link #eventId()}.</p>
 *
 * <p>This module is CONTRACTS ONLY — no business logic. See README §10 and the {@code add-event} skill.</p>
 */
