...
public abstract class BaseTenantStatusChangedConsumer extends BaseKafkaConsumer {
  ...
  /** Topic to subscribe to. Property: {@code storeql.kafka.topics.tenant-status-changed}. */
  @Inject
  @ConfigProperty(
      name = "storeql.kafka.topics.tenant-status-changed",
      defaultValue = "storeql.tenant.tenant-status-changed")
  String topicCfg;
