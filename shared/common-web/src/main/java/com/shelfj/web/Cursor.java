...
/**
 * Helper for cursor-based pagination (README §7.3). Lists use {@code ?after=<cursor>&limit=<n>} — no page numbers.
 * Default limit 20, max 100. A cursor is an opaque base64 token (here, wrapping the last-seen sort key).
 */
public final class Cursor {
    ...
    public static String decode(String token) {
        ...
        try {
            ...
            throw ApiException.badRequest("INVALID_CURSOR", "Malformed pagination cursor");
        }
    }
}
