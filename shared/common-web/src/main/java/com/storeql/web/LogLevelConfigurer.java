 ...
 * default to INFO and this raises or lowers {@code com.storeql} at startup from the environment.
 *
 * <p>Reads {@code -Dstoreql.log.level} first, then {@code STOREQL_LOG_LEVEL}, then leaves the file
 ...
 *
 * <p>Only {@code com.storeql} moves. The per-package damping for Helidon, Weld, Kafka and friends
...
public class LogLevelConfigurer {
  ...
  static final String SYSTEM_PROPERTY = "storeql.log.level";
  static final String ENV_VAR = "STOREQL_LOG_LEVEL";
  static final String APPLICATION_LOGGER = "com.storeql";
