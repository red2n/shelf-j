 ...
 * header. The token is injected from the environment variable {@code STOREQL_CONFIG_TOKEN} and must
...
public class ConfigAuthFilter implements ContainerRequestFilter {
  ...
  @Inject
  public ConfigAuthFilter(@ConfigProperty(name = "storeql.config.token") String token) {
